...
if (isset($_POST['submit'])) {
    ...
    if(!empty($errorMessages)){
        ...
        if($result){
            ...
            log_event($db, "New Thread", htmlentities($_SESSION['uname'], ENT_QUOTES, 'UTF-8'), "New thread created with title: " . htmlentities($_POST['title'], ENT_QUOTES, 'UTF-8'));
        } else {
            ...
            log_event($db, "New Thread", htmlentities($_SESSION['uname'], ENT_QUOTES, 'UTF-8'), "New thread creation failed with title: " . htmlentities($_POST['title'], ENT_QUOTES, 'UTF-8') . ' errorcode ' . htmlentities($errorsql, ENT_QUOTES, 'UTF-8'));
        }
